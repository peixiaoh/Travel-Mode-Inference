...
filename = 'data/Revised_InstanceCreation+NoJerkOutlier+Smoothing.pickle'
...
with open(filename, 'rb') as f:
    Total_RelativeDistance, Total_Speed, Total_Acceleration, Total_Jerk, Total_BearingRate, Total_Label, \
        Total_InstanceNumber, Total_Instance_InSequence, Total_Delta_Time, Total_Velocity_Change = \
...
with open('data/Revised_KerasData_Smoothing.pickle', 'wb') as f:  # Python 3: open(..., 'wb')
